...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        ...
        <aside id="sidebar" class="sidebar expanded bg-gray-600 text-white p-6">
     	<div class="flex justify-center mb-12">
                <img src="../img/clogo.jpg" alt="Logo" class="contact-images">
            </div>
			<nav class="flex flex-col h-full">
			    <ul class="space-y-6 text-lg flex-grow">
			        <li>
			            <a href="#" class="flex items-center py-3 px-4 bg-gray-600 hover:bg-gray-800 transition duration-300 rounded-lg">
			                <i class="fas fa-tachometer-alt mr-4"></i>
			                <span class="sidebar-text flex-1">Dashboard</span>
			            </a>
			        </li>
					<li>
					    <a href="#" id="importBtn" class="flex items-center py-3 px-4 hover:bg-gray-700 transition duration-300 rounded-lg">
					...
					<li>
					    <a href="../exportContacts" class="flex items-center py-3 px-4 hover:bg-gray-700 transition duration-300 rounded-lg">
			        ...
			        <li>
			            <a href="#" class="flex items-center py-3 px-4 hover:bg-gray-700 transition duration-300 rounded-lg">
			        ...
			        <li class="mt-auto">
			            <a href="logout.jsp" class="flex items-center py-3 px-4 hover:bg-gray-700 bg-gray-600 transition duration-300 rounded-lg">
     ...
     <main class="flex-1 p-8 lg:p-12 bg-gray-500">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-center mb-10 space-y-4 lg:space-y-0">
                <div class="flex items-center space-x-4 w-full lg:w-auto">
                    ...
                    <button class="bg-gray-600 text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition duration-300">Search</button>
                </div>
                <button id="mainAddContactButton" class="bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition duration-300 flex items-center cursor-pointer">
	    ...
	    <div class="bg-white rounded-lg shadow-lg p-6 w-96">
	        ...
	        <form id="addContactForm" action="../contacts" method="post" enctype="multipart/form-data">
	            ...
	            <div class="flex justify-between">
	                <button type="button" id="closePopup" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg">Cancel</button>
	                <button type="submit" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg">Add Contact</button>
	            </div>
	        </form>
	    </div>
	</div>
 ...
 <!-- Contact Modal -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Function to open the contact details modal
            ...
            editContactBtn.onclick = function() {
                ...
                contactModal.style.display = "none"; // Hide contact modal
                editContactModal.style.display = "block"; // Show edit modal
            };
